        ...
        <nav className="font-palanquin w-full flex justify-between items-center">
          ...
          <div className="flex gap-2">
            {isLoggedIn() ? (
              ...
              <NavLink
                className="flex border-2 rounded-full p-1 px-4 gap-2 justify-center items-center cursor-pointer dark:text-black bg-transparent hover:bg-transparent border-white dark:border-black hover:border-black dark:hover:border-white"
                to={toNavigate}
              >

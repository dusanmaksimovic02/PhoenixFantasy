...
namespace StatsApi.Services
{
    public class RabbitMQService : BackgroundService, IRabbitMQService
    {
        ...
        private const string StatsExchange = "stats.topic";
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                Console.WriteLine($"[RabbitMQ] Exchange '{StatsExchange}' declared!");
        ...
        public async Task PublishToExchangeAsync(string exchangeName, string routingKey, string message)
        {
            ...
            try
            {
                ...
                Console.WriteLine($"[RabbitMQ] Published to exchange '{exchangeName}' with key '{routingKey}'");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"[RabbitMQ ERROR] Failed to publish to exchange: {ex.Message}");
            }
        }

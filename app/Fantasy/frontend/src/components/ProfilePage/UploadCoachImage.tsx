...
import { uploadCoachImage} from "../../services/ImageService";
...
const ImageUpload: React.FC<ImageUploadProps> = ({ coachId, onUploadSuccess }) => {
  const queryClient = useQueryClient();
  const [isUploading, setIsUploading] = useState(false);

  const uploadMutation = useMutation({
    mutationFn: (file: File) => uploadCoachImage(coachId, file),
    onSuccess: () => {

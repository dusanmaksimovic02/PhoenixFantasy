...
import homeStart from "../../assets/images/kos.png";
import ball from "../../assets/images/ball.png";
import type { FC } from "react";
import { motion } from "framer-motion";
import ballTexture from "../../assets/images/basket-texture-orange-vector.jpg";
...
const HomeStart: FC = () => {
  ...
  return (
    <div className="h-screen gap-10 flex justify-center items-center max-sm:flex-col max-sm:h-svh max-sm:w-svw  max-sm:gap-0 overflow-hidden">
      <img
        src={ballTexture}
        alt="ball texture"
        className="w-full h-full overflow-hidden  max-sm:h-svh max-sm:w-svw"
      />
      <div className="absolute h-screen w-full gap-10 pt-15 flex justify-center items-center max-sm:flex-col max-sm:h-svh max-sm:w-svw max-sm:pt-50 max-sm:gap-0 bg-black/30 overflow-hidden">
        <div className="h-full w-[50%] flex flex-col justify-center pl-23 max-sm:pl-0 gap-2 max-sm:justify-center max-sm:items-center max-sm:h-svh max-sm:w-svw text-nowrap text-white">
        ...
        <div className="relative h-full w-[40%] pt-15 flex flex-col justify-center items-center max-sm:pt-0  max-sm:w-svw max-sm:p-7 ">
          {/* <img src={homeStart} alt="basketball" className="h-150 w-200" /> */}
          <img
            src={homeStart}
            alt="basketball hoop"
            className="w-150 h-100 pt-15 z-1 max-sm:w-80 max-sm:h-75 max-xl:w-120 max-xl:h-90 max-lg:w-100 max-lg:h-80"
          />
          <motion.img
            src={ball}
            alt="basketball ball"

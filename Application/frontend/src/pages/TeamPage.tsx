...
import { TeamFull } from "../models/TeamFull.model";
  ...
  return (
    <>
      <div className="pt-[3.5rem] h-fit w-screen font-palanquin min-h-screen">
        ...
        <div className="">
          <Tabs defaultValue="club-history">
            ...
            <Tabs.Panel value="club-history" className="p-5 sm:text-[1.rem]">
              {history}
            </Tabs.Panel>
            <Tabs.Panel value="players" className="p-5">
              <Players players={team!.players} />
            </Tabs.Panel>
            <Tabs.Panel value="coaches" className="p-5">

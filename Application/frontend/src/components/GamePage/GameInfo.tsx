        ...
        <thead className="border-2 border-surface bg-surface-light text-foreground dark:bg-surface-dark">
          ...
          <tbody className="group text-black dark:text-white">
            <tr className="border-2 border-surface last:border-0 even:bg-surface-light dark:even:bg-surface-dark">
              ...
              <td className="p-3 text-center font-bold text-lg">Performance Index Rating</td>
            ...
            <tr className="border-2 border-surface last:border-0 even:bg-surface-light dark:even:bg-surface-dark">
              ...
              <td className="p-3 text-center font-bold text-lg">Minutes Played</td>
            ...
            <tr className="border-2 border-surface last:border-0 even:bg-surface-light dark:even:bg-surface-dark">
              ...
              <td className="p-3 text-center font-bold text-lg">Free Throws Percentage</td>
            ...
            <tr className="border-2 border-surface last:border-0 even:bg-surface-light dark:even:bg-surface-dark">
              ...
              <td className="p-3 text-center font-bold text-lg">Two Points Percentage</td>
            ...
            <tr className="border-2 border-surface last:border-0 even:bg-surface-light dark:even:bg-surface-dark">
              <td className="p-3 text-center">Player 1</td>
              <td className="p-3 text-center">100%</td>
              <td className="p-3 text-center font-bold text-lg">Three Points Percentage</td>

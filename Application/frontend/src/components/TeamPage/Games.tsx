  ...
  return (
    <div className="flex flex-col gap-5">
      {games.map((game, index) => (
        <div
          key={index}
          className="flex max-sm:flex-col justify-between items-center gap-5 p-5 bg-surface-light dark:bg-surface-dark  dark:bg-opacity-70 rounded-3xl "
        >
          <div className="flex justify-center items-center flex-col gap-3 text-center">
            <img src={game.homeLogo} alt="home logo" className="w-36 h-36" />

...
const TopPlayer = () => {
  ...
  return (
    <div className="p-5 pt-10 flex gap-10 flex-col max-sm:justify-center max-sm:items-center font-palanquin px-24">
      ...
      <div className="flex gap-10 justify-around p-8 overflow-x-scroll max-sm:w-svw scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-700 scrollbar-thumb-rounded-full scrollbar-track-rounded-full hover:scrollbar-thumb-gray-400 active:scrollbar-thumb-gray-300 ">
